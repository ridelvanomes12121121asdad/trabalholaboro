// O evento DOMContentLoaded garante que o script só roda depois que a página HTML inteira foi carregada.
document.addEventListener('DOMContentLoaded', function() {
    ...
    indicators.forEach(indicator => {
        indicator.addEventListener('click', (e) => goToSlide(parseInt(e.target.dataset.slideTo, 10)));
    });
    ...
    let particlesArray;
    const particleColors = ['rgba(147, 51, 234, 0.6)', 'rgba(168, 85, 247, 0.6)', 'rgba(255, 255, 255, 0.3)'];
